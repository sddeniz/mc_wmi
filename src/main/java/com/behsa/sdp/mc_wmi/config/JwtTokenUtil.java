...
public class JwtTokenUtil implements Serializable {
    ...
    public String getHeadersFromToken(String token) {


        String claimFromToken = getClaimFromToken(token, Claims::getIssuer);
    ...
    public <T> T getJwsHeaderFromToken(String token, Function<JwsHeader, T> headerTFunction) {
        final JwsHeader claims = getHeaderClaimsFromTokens(token);

        return (T) claims;
    }


    private JwsHeader getHeaderClaimsFromTokens(String token) {
